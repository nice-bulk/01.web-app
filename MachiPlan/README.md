...
🌐 **デモサイト**: https://machiplan.vercel.app/
...
### 生成結果 — タイムライン（1）
![プラン表示1](images/plan1.png)

### 生成結果 — タイムライン（2）
![プラン表示2](images/plan2.png)

### 生成結果 — タイムライン（3）
![プラン表示3](images/plan3.png)

### 生成結果 — タイムライン（4）
![プラン表示4](images/plan4.png)

### 生成結果 — タイムライン（5）
![プラン表示5](images/plan5.png)

---

## デモモード

`VITE_GEMINI_API_KEY` 環境変数が設定されていない場合、自動的に**モックデータモード**で動作します。  
APIキーなしでも全機能（プラン生成・PDF出力）を体験できます。

| 入力した町名 | モックデータ |
|---|---|
| `京都` | 伏見稲荷・金閣寺・嵐山など定番コースの詳細プラン |
| `函館` | 朝市・元町洋館・函館山夜景などの詳細プラン |
| その他の町名 | 町名に合わせて動的に生成されるプラン |

> Vercel / Netlify など環境変数を設定せずデプロイするだけでデモとして公開できます。
